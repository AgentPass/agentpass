resource "aws_elastic_beanstalk_application" "app" {
  ...
  description = "${var.project_name} ${var.application_name} frontend application"
...
resource "aws_elastic_beanstalk_environment" "env" {
  ...
  setting {
    namespace = "aws:ec2:vpc"
    name      = "Subnets"
    value     = join(",", concat(var.public_subnet_ids, var.private_subnet_ids))
  }
  ...
  setting {
    ...
    value     = var.backend_endpoint != "" ? var.backend_endpoint : "http://backend.internal"
  }
